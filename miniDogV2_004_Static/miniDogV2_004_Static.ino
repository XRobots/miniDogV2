...
int servo1Offset = 1380;
int servo2Offset = 1570;
...
void loop() {
  ...
  if (currentMillis - previousMillis >= 10) {  // start timed event
        ...
        // ******************** STATICALLY STABLE *********************************
            ...
            int offsetX = (offsetX - 25) - x;
            int offsetY = offsetY + 25;
            ...
            kinematics (1, mode, currentLeg1x+offsetX, currentLeg1y-offsetY, currentLeg1z, r, p, yaw);   // front left leg  
            kinematics (2, mode, currentLeg2x+offsetX, currentLeg1y+offsetY, currentLeg2z, r, p, yaw);   // front right leg
            kinematics (3, mode, currentLeg3x+offsetX, currentLeg1y-offsetY, currentLeg3z, r, p, yaw);   // back left leg  
            kinematics (4, mode, currentLeg4x+offsetX, currentLeg1y+offsetY, currentLeg4z, r, p, yaw);   // back right leg                
        }
